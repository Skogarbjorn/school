// Dafny program e.dfy compiled into C#
...
// Command-line arguments: run e.dfy
// e.dfy
...
method SumIntsTailRecursive(i: int, r: int, k: int)
    returns (s: int)
  requires 0 <= i <= k
  requires r == (i + 1) * i / 2
...
namespace _module {
  ...
  public partial class __default {
    public static BigInteger SumInts(BigInteger k) {
      BigInteger _0___accumulator = BigInteger.Zero;
    TAIL_CALL_START: ;
      if ((k).Sign == 0) {
        return (BigInteger.Zero) + (_0___accumulator);
      } else {
        _0___accumulator = (k) + (_0___accumulator);
        BigInteger _in0 = (k) - (BigInteger.One);
        k = _in0;
        goto TAIL_CALL_START;
      }
    }
    public static BigInteger SumIntsLoop(BigInteger k)
    {
    ...
    public static BigInteger SumIntsRecursive(BigInteger k)
    {
      BigInteger s = BigInteger.Zero;
      s = k;
      if ((k).Sign != 0) {
        BigInteger _0_a;
        BigInteger _out0;
        _out0 = __default.SumIntsRecursive((k) - (BigInteger.One));
        _0_a = _out0;
        s = (s) + (_0_a);
      }
      return s;
    }
    public static BigInteger SumIntsTailRecursive(BigInteger i, BigInteger r, BigInteger k)
    {
      BigInteger s = BigInteger.Zero;
      if ((i) == (k)) {
        s = r;
      ...
      BigInteger _out0;
      _out0 = __default.SumIntsTailRecursive((i) + (BigInteger.One), ((r) + (i)) + (BigInteger.One), k);
      s = _out0;
      s = s;
      return s;
      return s;
    ...
    public static void _Main(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> __noArgsParameter)
    {
      BigInteger _0_s1;
      BigInteger _out0;
      _out0 = __default.SumIntsLoop(new BigInteger(5));
      _0_s1 = _out0;
      BigInteger _1_s2;
      BigInteger _out1;
      _out1 = __default.SumIntsRecursive(new BigInteger(5));
      _1_s2 = _out1;
      BigInteger _2_s3;
      BigInteger _out2;
      _out2 = __default.SumIntsTailRecursive(BigInteger.Zero, BigInteger.Zero, new BigInteger(5));
      _2_s3 = _out2;
      BigInteger _3_s4;
      BigInteger _out3;
      _out3 = __default.SumIntsTailRecursive(new BigInteger(4), new BigInteger(10), new BigInteger(5));
      _3_s4 = _out3;
      Dafny.Helpers.Print((_0_s1));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
      Dafny.Helpers.Print((_1_s2));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
      Dafny.Helpers.Print((_2_s3));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
      Dafny.Helpers.Print((_3_s4));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
    }
  }
